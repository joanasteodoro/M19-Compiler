#ifndef __M19_AST_BLOCK_NODE_H__
#define __M19_AST_BLOCK_NODE_H__
...
namespace m19 {
  ...
  /**
   * Class for describing a block node.
   */
  class block_node: public cdk::basic_node {
      cdk::sequence_node *_declarations, *_instructions;

    public:
        block_node(int lineno) :
			cdk::basic_node(lineno), _declarations(new cdk::sequence_node(lineno)), _instructions(new cdk::sequence_node(lineno)){
		}
